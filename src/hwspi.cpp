...
HWSpi::HWSpi(AvrDevice *_c,
    ...
    spdr_reg(core, this, "SPDR", this, &HWSpi::GetSPDR, &HWSpi::SetSPDR),
    spsr_reg(core, this, "SPSR", this, &HWSpi::GetSPSR, &HWSpi::SetSPSR),
    spcr_reg(core, this, "SPCR", this, &HWSpi::GetSPCR, &HWSpi::SetSPCR)
{
